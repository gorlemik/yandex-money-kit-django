# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-08 06:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scid', models.PositiveIntegerField(verbose_name='Номер витрины')),
                ('customer_number', models.CharField(default=yandex_money.models.get_random_string, max_length=64, verbose_name='Идентификатор плательщика')),
                ...
                ('order_number', models.CharField(default=yandex_money.models.get_random_string, max_length=64, verbose_name='Номер заказа')),
                ...
                ('success_url', models.URLField(verbose_name='URL успешной оплаты')),
                ('fail_url', models.URLField(verbose_name='URL неуспешной оплаты')),
